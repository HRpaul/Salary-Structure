    ...
    new Vue({
        ...
        data: {
            ...
            newSal: {
                ...
                tr: {
                    label: 'Internet & Mobile Allowance',
                    val: 0
                },
                cea: {
        ...
        methods: {
            ...
            repetitiveCodeForNew: function () {
                ...
                if (this.newSal.basic.val > 15000) {
                    ...
                    this.newSal.employeePf.val = this.newSal.employeePf.val > 1800 ? 1800 : this.newSal.employeePf.val;
                }
            ...
            repetitiveCodeForOld: function () {
                ...
                // Professional Tax
                if (this.oldSal.grossPay.val > 15000) {
                    if (this.oldSal.grossPay.val > 20000) {
                        this.oldSal.professionalTax.val = 200;
                    } else {
                        this.oldSal.professionalTax.val = 150;
                    }
                } else {
                    this.oldSal.professionalTax.val = 0;
                }
